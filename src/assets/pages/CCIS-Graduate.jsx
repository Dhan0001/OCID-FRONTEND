...
import { ChevronDown, X, Upload, FileText, Network, ArrowLeft } from "lucide-react"
import { getViewUrl } from "../utils/googleDriveUtils"

const CCISGraduate = () => {
  // Change the programs array to only include MSIT
  const programs = [
    {
      id: 1,
    ...
    onSuccess: async (tokenResponse) => {
      if (fileToUpload && selectedProgram !== null) {
        try {
          ...
          // Hardcoded folder ID for CCIS Graduate
          // This is the folder ID where all files will be uploaded directly
          const targetFolderId = "1oPfcm-Fq13HK4T_MGYqU_79iOP05mHcl" // Default folder ID
