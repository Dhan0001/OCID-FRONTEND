...
const CMNSUndergrad = () => {
  // Undergraduate programs for CMNS
  const programs = [
    {
      id: 1,
      name: "Bachelor of Science in Mathematics (BS Math)",
      icon: Calculator,
      color: "from-teal-600 to-teal-800",
      description:
        "The Bachelor of Science in Mathematics (BS Math) program provides a strong foundation in mathematical theory, analysis, and applications. Students study calculus, algebra, statistics, and mathematical modeling. The program prepares graduates for careers in data analysis, actuarial science, financial mathematics, and other fields requiring strong quantitative skills.",
      curriculumFiles: {
    ...
    {
      id: 2,
      name: "Bachelor of Science in Biology (BS Biology)",
      icon: Microscope,
      color: "from-teal-500 to-teal-700",
      description:
        "The Bachelor of Science in Biology (BS Biology) program explores the study of living organisms and their interactions with the environment. Students learn about cell biology, genetics, ecology, and physiology. The program prepares graduates for careers in research, healthcare, environmental management, and biotechnology.",
      curriculumFiles: {
        2023: "/placeholder.svg?height=800&width=600",
        2020: "/placeholder.svg?height=800&width=600",
        2014: "/placeholder.svg?height=800&width=600",
    ...
    },
    {
      ...
      description:
        "The Bachelor of Science in Chemistry (BS Chemistry) program focuses on the study of matter, its properties, and transformations. Students learn about organic chemistry, inorganic chemistry, analytical chemistry, and physical chemistry. The program prepares graduates for careers in chemical research, pharmaceutical development, materials science, and environmental analysis.",
      curriculumFiles: {
        2023: "/placeholder.svg?height=800&width=600",
        2020: "/placeholder.svg?height=800&width=600",
      },
    },
    {
      ...
      color: "from-teal-500 to-teal-700",
      description:
        "The Bachelor of Science in Physics (BS Physics) program explores the fundamental principles governing the universe. Students study mechanics, electromagnetism, thermodynamics, and quantum physics. The program prepares graduates for careers in research, engineering, data science, and other fields requiring strong analytical and problem-solving skills.",
      curriculumFiles: {
        2023: "/placeholder.svg?height=800&width=600",
        2020: "/placeholder.svg?height=800&width=600",
      },
    ...
    {
      id: 5,
      name: "Bachelor of Science in Statistics (BS Stat)",
      icon: BarChart,
      color: "from-teal-600 to-teal-800",
      description:
        "The Bachelor of Science in Statistics (BS Stat) program focuses on the collection, analysis, interpretation, and presentation of data. Students learn statistical theory, experimental design, data analysis, and statistical computing. The program prepares graduates for careers in data science, market research, biostatistics, and other fields requiring strong statistical skills.",
      curriculumFiles: {
        2023: "/placeholder.svg?height=800&width=600",
        2020: "/placeholder.svg?height=800&width=600",
      },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-teal-700 to-teal-900 text-white py-12">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center text-center">
            {/* CMNS Logo */}
            <div className="w-24 h-24 bg-white rounded-full p-1 flex-shrink-0 mb-6">
              <img src="/images/logos/cmns-logo.png" alt="CMNS Logo" className="w-full h-full object-contain" />
            </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-lg bg-gradient-to-r from-teal-600 to-teal-700 text-white hover:from-teal-700 hover:to-teal-800 transition-all duration-300 text-center text-sm shadow-sm hover:shadow-md flex items-center"
            >
          ...
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto shadow-2xl">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-teal-700">Program Description</h3>
                <button
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="mt-6">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-700">
                    <li>Develop strong analytical and problem-solving skills in scientific disciplines</li>
                    <li>Build a solid foundation in mathematical and scientific principles</li>
                    <li>Cultivate research skills and scientific inquiry methods</li>
                    <li>Prepare students for careers in science, research, and technology</li>
                    <li>Foster critical thinking and evidence-based decision making</li>
                  </ul>
                </div>
